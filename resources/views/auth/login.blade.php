...
<div x-data="loginForm()">
    ...
    <div class="space-y-3">
        <a href="/auth/google/redirect{{ request()->query('redirect_after') ? '?redirect_after=' . urlencode(request()->query('redirect_after')) : '' }}"
        ...
        <a href="/auth/apple/redirect{{ request()->query('redirect_after') ? '?redirect_after=' . urlencode(request()->query('redirect_after')) : '' }}"
