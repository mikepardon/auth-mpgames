...
@section('title', 'Register - MPGames')
...
<div x-data="registerForm()">
    ...
    <form @submit.prevent="submit">
        <div class="mb-4">
            ...
            <input type="text" x-model="form.username" required autofocus minlength="4" maxlength="20" pattern="[a-zA-Z0-9]+"
            ...
            <p class="text-xs text-slate-500 mt-1">4-20 characters, letters and numbers only</p>
        </div>
    ...
    return {
        ...
        async submit() {
            ...
            try {
                ...
                if (!res.ok) {
                    this.error = data.message || Object.values(data.errors || {}).flat()[0] || 'Registration failed.';
